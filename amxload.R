...
amxload <- function(wav.path,store.data.path,newfilename){
...
# Windows style path
#path = "D:/VanOord/2018 Van Oord Turtles/Data/14032018_CEE/14032018/2018-03/wav" #where is the data located?
path = wav.path
...
turtle = list(A = aList, M = mList, G = gList, P = pList, T = tList, L = rgbList)

#setwd("D:/VanOord/2018 Van Oord Turtles/Analysis/cm68_09032018")
#save(turtle,file='cm68.RData')

setwd(store.data.path)
save(turtle,file=newfilename)
}
